...
async function createPendingOrder(client, payload) {
  const {
    customerName, customerPhone, specialInstructions, items,
    fulfillmentType = 'collection',
    shippingTier, deliveryName, deliveryPhone,
  ...
  const orderResult = await client.query(`
    insert into bakery_orders (
      ...
      order_number, total_amount, service_fee, shipping_cost,
      stripe_payment_intent_id, fulfillment_type, shipping_tier,
